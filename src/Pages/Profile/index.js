...
const Profile = ({ user, role, avatarBase64 }) => {
    ...
    user ??= currentUser
    const currentAvatarBase64 = useSelector(
        (state) => state.auth.credentials.avatarBase64
    )
    ...
    const updateCandidate = async (
        ...
        id,
        navigate
    ) => await doUpdateCandidate(axiosPrivate, dispatch, data, id, navigate)
    const updateEmployer = async (axiosPrivate, dispatch, data, id, navigate) =>
        await doUpdateEmployer(axiosPrivate, dispatch, data, id, navigate)
    const handleSave = () => {
                ...
                <Card.Header className="d-flex align-items-center flex-column gap-2">
                    <div className="d-flex justify-content-end w-100">
                        <BorderColorIcon
                            ...
                            style={{
                                color: '#5767aa',
                                boxShadow: 'rgba(0, 0, 0, 0.35) 2px 3px 2px',
                            }}
                            fontSize="large"
                        />
                    </div>
                        ...
                        {isEdit ? (
                            <Form.Group>
                                ...
                                <Form.Control
                                    ...
                                    onChange={async (e) => {
                                        const avaBase64 = await toBase64(
                                            e.target.files[0]
                                        )
